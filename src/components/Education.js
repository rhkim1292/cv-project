...
const Education = () => {
	...
	const startAddSchoolMode = (e) => {
		setAddSchoolMode(true);
	};

	const stopAddSchoolMode = (e) => {
		setAddSchoolMode(false);
	};
	...
	return (
		...
		>
			...
			{editMode && !addSchoolMode ? (
				<button className="add-school-btn" onClick={startAddSchoolMode}>
					Add School
				</button>
			) : null}

			{editMode ? (
				<button className="education-submit-btn" onClick={stopEditMode}>
					Submit
				</button>
			) : null}

			{hovering && !editMode ? (
				<button className="education-edit-btn" onClick={startEditMode}>
					Edit
				</button>
			) : null}
		</div>
...
// 			addSchoolMode: false,
// 		};
// 		makeEditBtnVisible = makeEditBtnVisible.bind(this);
// 		makeEditBtnInvisible = makeEditBtnInvisible.bind(this);
// 		startEditMode = startEditMode.bind(this);
// 		stopEditMode = stopEditMode.bind(this);
// 		startAddSchoolMode = startAddSchoolMode.bind(this);
// 		stopAddSchoolMode = stopAddSchoolMode.bind(this);
// 	}
